...
def dummyordercategory(request):	
	if ('loggedin' not in request.session):
		...
		n.body='Your order with '+str(order.seller.nameOfSeller)+' INR '+str(order.subtotal)+ ' has been created.'
		n.link = 'orderDetail?orderId='+str(order_id)
		n.save()
		miveuser.notifications.add(n)
		miveuser.save()
		strr = '/main?notify=ye&title=Order Recieved&description=Your order with '+str(order.seller.nameOfSeller)+' INR '+str(order.subtotal)+ ' has been created.'
